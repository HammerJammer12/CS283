...
https://github.com/HammerJammer12/CS283

4. Briefly describe what you want to get out of this class.
Hoping to gain a better profiency in C and about many of the processes that are performed "under the hood" by the
operating system
5. Briefly describe any concerns you might be having with being successful in this class (if any).
Right now, just that my C is very rusty.
